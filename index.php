					...
					<ul class="top-menu">
						<li class="top-btn">
							<a href="#" title="Закладки">
								<span class="top-menu__icons">
								<svg class="icon-bookmark" xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16"><path d="M14 15c0 .55-.368.741-.818.426l-5.363-3.765c-.45-.315-1.187-.315-1.637 0L.818 15.426C.368 15.741 0 15.55 0 15V1c0-.55.45-1 1-1h12c.55 0 1 .45 1 1v14z"/></svg>
								</span>
							Закладки: 0</a>
						</li>
						<li class="top-btn">
							<a href="#" title="Корзина">
								<span class="top-menu__icons">
								<svg class="icon-cart" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15"><circle cx="4.5" cy="13.5" r="1.5"/><circle cx="12.5" cy="13.5" r="1.5"/><path d="M15 2H4.07l-.422-2H0v2h2.031l1.985 9H15V9H9.441L15 6.951z"/></svg>
								</span>
							Корзина: 0</a>
						</li>
						<li class="top-btn green">
							<a href="#">Офоромить заказ</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="users-wrap">
						...
						<div class="title-contacts">
							<div class="title-number">
								...
								<a href="tel:+74955550555">+7 (495) 555-05-55</a>
							</div>
				...
				<section class="promo-items col-1">
					...
					<div class="slider">
						<figure class="slider-content">
								<img src="#" width="620" height="266" alt="">
							</figure>
			...
			<div class="container">
				...
				<section class="popular-items">
					<article class="pop-item">
						<img src="#" height="164" width="184" alt="Перфоратор BOSCH BFG 9000">
					...
					<article class="pop-item">
						...
						<span class="old-price">30 500 Р.</span><br>
						<span class="price">25 500 Р.</span>
					</article>
					<article class="pop-item">
						<img src="#" height="164" width="184" alt="Перфоратор BOSCH BFG 9000">
						<span class="promo-stock">new</span>
		...
		<div class="main-servises">
			<div class="container">
				...
				<section class="descr-servises">
					<span class="title-descr-serivses">Доставка</span>
			...
			<div class="second-footer">
				<div class="container">
					...
					<section class="copyright">
						<div class="feedback">
							Обратная связь:<br>
							<a href="mailto:info@technomart.ru" class="footer-back">mail@htmlacademy.ru</a>
						</div>
						<div class="design">
							Разработано —<br>
							<a href="mailto:info@technomart.ru" class="footer-back">htmlacademy.ru</a>
						</div>
					</section>
				</div>
			</div>
